...
{
	// TODO: change this to apply a gameplay effect, using const_cast as temp hack
...
void AAuraEffectActor::BeginPlay()
{
	...
	Sphere->OnComponentEndOverlap.AddDynamic(this, &AAuraEffectActor::AAuraEffectActor::EndOverlap);
}
